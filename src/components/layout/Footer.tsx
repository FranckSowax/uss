    ...
    <footer className="bg-dark text-white py-12">
      <div className="container-page">
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-8">
          <div>
            <div className="flex items-center space-x-2 mb-6">
              ...
              <span className="font-montserrat font-semibold text-xl">USS</span>
            </div>
            <p className="text-gray-300 mb-4">
              L&apos;Université des Sciences de la Santé forme les professionnels de la santé de demain avec excellence et innovation.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-gray-300">
              ...
              <li><Link href="/filieres" className="hover:text-white">Formations</Link></li>
              <li><Link href="/admissions" className="hover:text-white">Admission</Link></li>
              <li><Link href="/vie-etudiante" className="hover:text-white">Vie étudiante</Link></li>
          ...
          <div>
            ...
            <ul className="space-y-2 text-gray-300">
              <li>Campus universitaire, Libreville</li>
              <li>contact@uss-gabon.com</li>
          ...
          <div>
            ...
            <div className="mt-6">
              ...
              <div className="flex mt-2">
                ...
                />
                <button className="bg-accent text-dark px-4 py-2 rounded-r-lg font-medium">
                  OK
                </button>
              </div>
            </div>
        ...
        <div className="mt-12 pt-8 border-t border-gray-700 text-center text-gray-400">
          <p>© {new Date().getFullYear()} Université des Sciences de la Santé. Tous droits réservés.</p>
        </div>
      </div>
    </footer>
  );
